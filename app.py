    ...
    # =========================================================================
        ...
        if aba_av_escolhida == "Criar":
            ...
            if not st.session_state.selected_aluno_av or not st.session_state.selected_turma_av:
                ...
                # Inicializa as variáveis para o sistema não quebrar
                scanned_id_from_camera = None
                if 'foto_codigo_barras' not in st.session_state:
                    st.session_state['foto_codigo_barras'] = None

                # Seu código customizado que abre a câmera traseira perfeitamente
                ...
                <script>
                    ...
                    b.addEventListener('click', () => {
                        ...
                        // Envia o dado para o Streamlit de forma segura
                        Streamlit.setComponentValue(dataUrl);
                    });
                </script>
                """, height=390)

                # Só salva no estado da sessão se o usuário REALMENTE clicou no botão (evita travar o iFrame)
