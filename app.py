    ...
    # =========================================================================
        ...
        if aba_av_escolhida == "Criar":
            ...
            if not st.session_state.selected_aluno_av or not st.session_state.selected_turma_av:
                ...
                # Abre a câmera oficial e estável do Streamlit (O botão SEMPRE funciona)
                foto_registro = st.camera_input("Tire a foto do código de barras da prova", key="camera_scanner_oficial")
                ...
                if foto_registro is not None:
                    try:
                        ...
                        # Converte a foto capturada pelo botão nativo para o OpenCV
                        ...
                        if codigos_detectados:
                            ...
                            st.warning("⚠️ Foto tirada, mas o código de barras não foi detectado. Se abrir na frontal, use o ícone de girar a câmera do visor para ativar a traseira.")
                    except Exception as e:
